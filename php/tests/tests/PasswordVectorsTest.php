...
class PasswordVectors extends VectorBase {
	...
	public function testAllFieldsEmptyOrZero() {
		$vector = json_decode('{"title":"All fields empty or zero","version":"3","password":"","enc_salt":"0000000000000000","hmac_salt":"0000000000000000","iv":"00000000000000000000000000000000","plaintext":"","ciphertext":"03010000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 0000e73c 3a20a905 8bbd1622 2b2d52f3 94ebe0f2 90c2290c 3b4ce61e e9b7b73f 593ef584 c5053156 1822bf00 567c2838 f546"}');
		$this->_runPasswordTest($vector);

	}

	public function testOneByte() {
		$vector = json_decode('{"title":"One byte","version":"3","password":"thepassword","enc_salt":"0001020304050607","hmac_salt":"0102030405060708","iv":"02030405060708090a0b0c0d0e0f0001","plaintext":"a","ciphertext":"03010001 02030405 06070102 03040506 07080203 04050607 08090a0b 0c0d0e0f 0001de17 cb07d089 c061385c 20fd3d47 74c717ba fac9d70f ce79f56a 6f65c1a7 cd790b15 6b8aef33 6227a442 3ce79ae5 abce"}');
		$this->_runPasswordTest($vector);

	}

	public function testExactlyOneBlock() {
		$vector = json_decode('{"title":"Exactly one block","version":"3","password":"thepassword","enc_salt":"0102030405060700","hmac_salt":"0203040506070801","iv":"030405060708090a0b0c0d0e0f000102","plaintext":"0123456789abcdef","ciphertext":"03010102 03040506 07000203 04050607 08010304 05060708 090a0b0c 0d0e0f00 01020e43 7fe80930 9c03fd53 a475131e 9a1978b8 eaef576f 60adb8ce 2320849b a32d7429 00438ba8 97d22210 c76c35c8 49df"}');
		$this->_runPasswordTest($vector);

	}

	public function testMoreThanOneBlock() {
		$vector = json_decode('{"title":"More than one block","version":"3","password":"thepassword","enc_salt":"0203040506070001","hmac_salt":"0304050607080102","iv":"0405060708090a0b0c0d0e0f00010203","plaintext":"0123456789abcdef 01234567","ciphertext":"03010203 04050607 00010304 05060708 01020405 06070809 0a0b0c0d 0e0f0001 0203e01b bda5df2c a8adace3 8f6c588d 291e03f9 51b78d34 17bc2816 581dc6b7 67f1a2e5 7597512b 18e1638f 21235fa5 928c"}');
		$this->_runPasswordTest($vector);

	}

	public function testMultibytePasswordAndText() {
		$vector = json_decode('{"title":"Multibyte password and text","version":"3","password":"\u4e2d\u6587\u5bc6\u7801","enc_salt":"0304050607000102","hmac_salt":"0405060708010203","iv":"05060708090a0b0c0d0e0f0001020304","plaintext":"\u4e00\u70b9\u4e2d\u6587\u3002","ciphertext":"03010304 05060700 01020405 06070801 02030506 0708090a 0b0c0d0e 0f000102 030407f1 a50eef3f 48ad4638 56d79751 e604d107 e6e3cf01 01f29287 67083c95 16d94982 d9fdd5a8 1b2b369c da9d781a 43a3"}');
		$this->_runPasswordTest($vector);
